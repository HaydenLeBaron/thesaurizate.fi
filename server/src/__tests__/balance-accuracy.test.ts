...
describe('Balance Calculation Accuracy Tests', () => {
  ...
  beforeEach(async () => {
    ...
    const userId1 = users[0].body.id;
    const userId2 = users[1].body.id;
    const userId3 = users[2].body.id;
    ...
    account1Id = accounts[0].body.id;
    account2Id = accounts[1].body.id;
    account3Id = accounts[2].body.id;
  });
  ...
  describe('Complex Balance Calculations', () => {
    ...
    it('should maintain correct balances in circular transfer scenario', async () => {
      ...
      // account2: 20000 + 5000 - 7000 = 18000
      expect(balances[1].body.balance).toBe(18000);
      // account3: 10000 + 7000 - 3000 = 14000
  ...
  describe('Money Conservation (Invariant Testing)', () => {
    ...
    it('should conserve money even with complex transfer patterns', async () => {
      ...
      // Random transfers
      const transfers = [
        { from: account1Id, to: account2Id, amount: 12345 },
        { from: account2Id, to: account3Id, amount: 6789 },
        { from: account3Id, to: account1Id, amount: 23456 },
        { from: account1Id, to: account3Id, amount: 7890 },
        { from: account2Id, to: account1Id, amount: 11111 },
        { from: account3Id, to: account2Id, amount: 9876 },
      ];
