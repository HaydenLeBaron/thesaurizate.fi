...
- Schema validation
- Transaction and account API endpoints
- Health checks
...
**Description:** Stress test that progressively ramps up from 0 to 1000 concurrent virtual accounts executing random transactions between 10,000 accounts with $100M initial balance each. Tests system performance under heavy load with thresholds for request duration (p95 < 1000ms) and failure rate (< 10%). Includes data integrity verification in teardown.
...
INFO[0035] Created 10000 accounts with initial balances     source=console
INFO[0165]
...
**Description:** Balance read throughput test with complex setup. Creates 1000 accounts with 10-100 random transactions each (realistic workload), then executes 50,000 balance read requests across 100 concurrent virtual accounts. Tests balance endpoint performance under heavy transaction history with thresholds for request duration (p95 < 100ms), failure rate (< 1%), and throughput (> 250 reads/sec).
...
INFO[0000] Setting up test accounts for balance reads...    source=console
INFO[0004] Created 1000 accounts with balances              source=console
INFO[0004] Creating 10-100 transactions per account to build transaction history...  source=console
INFO[0023] Created transactions for 100/1000 accounts (6302 total transactions so far)  source=console
INFO[0039] Created transactions for 200/1000 accounts (11458 total transactions so far)  source=console
INFO[0056] Created transactions for 300/1000 accounts (17245 total transactions so far)  source=console
INFO[0074] Created transactions for 400/1000 accounts (22879 total transactions so far)  source=console
INFO[0092] Created transactions for 500/1000 accounts (28685 total transactions so far)  source=console
INFO[0109] Created transactions for 600/1000 accounts (34413 total transactions so far)  source=console
INFO[0128] Created transactions for 700/1000 accounts (40431 total transactions so far)  source=console
INFO[0147] Created transactions for 800/1000 accounts (45905 total transactions so far)  source=console
INFO[0167] Created transactions for 900/1000 accounts (52423 total transactions so far)  source=console
INFO[0184] Created transactions for 1000/1000 accounts (58580 total transactions so far)  source=console
INFO[0184] Setup complete: 1000 accounts, 58580 transactions created  source=console
INFO[0196]
...
**Description:** Balance read throughput test with simple setup. Creates 1000 accounts with exactly 1 deposit transaction each, then executes 50,000 balance read requests across 100 concurrent virtual accounts. Tests balance endpoint performance under minimal transaction history with thresholds for request duration (p95 < 100ms), failure rate (< 1%), and throughput (> 1000 reads/sec).
...
INFO[0000] Setting up test accounts for simple balance reads...  source=console
INFO[0000] Creating accounts...                             source=console
INFO[0000] Created 100/1000 accounts                        source=console
INFO[0000] Created 200/1000 accounts                        source=console
INFO[0000] Created 300/1000 accounts                        source=console
INFO[0000] Created 400/1000 accounts                        source=console
INFO[0000] Created 500/1000 accounts                        source=console
INFO[0000] Created 600/1000 accounts                        source=console
INFO[0000] Created 700/1000 accounts                        source=console
INFO[0001] Created 800/1000 accounts                        source=console
INFO[0001] Created 900/1000 accounts                        source=console
INFO[0001] Created 1000/1000 accounts                       source=console
INFO[0001] Created 1000 accounts                            source=console
INFO[0001] Creating exactly 1 deposit transaction per account...  source=console
INFO[0001] Created deposits for 100/1000 accounts           source=console
INFO[0001] Created deposits for 200/1000 accounts           source=console
INFO[0002] Created deposits for 300/1000 accounts           source=console
INFO[0002] Created deposits for 400/1000 accounts           source=console
INFO[0002] Created deposits for 500/1000 accounts           source=console
INFO[0002] Created deposits for 600/1000 accounts           source=console
INFO[0002] Created deposits for 700/1000 accounts           source=console
INFO[0003] Created deposits for 800/1000 accounts           source=console
INFO[0003] Created deposits for 900/1000 accounts           source=console
INFO[0003] Created deposits for 1000/1000 accounts          source=console
INFO[0003] Setup complete: 1000 accounts, 1000 transactions (1 per account)  source=console
INFO[0013]
